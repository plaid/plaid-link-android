...
// Add Item Token Flow - Create new items by using an item_add_token
app.post('/get_add_token', function(request, response, next) {
  client.createItemAddToken({
    ...
    ITEM_ADD_TOKEN = tokenResponse.add_token;
    prettyPrintResponse(tokenResponse);
    response.json({
      add_token: ITEM_ADD_TOKEN,
